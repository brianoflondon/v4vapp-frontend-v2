export default {
  ...
  clear_local_storage_message:
    "Isto é como desligar e ligar novamente. Isto irá limpar todo o armazenamento local e te desconectar. Você tem certeza?",
  // Dark Mode Selector
  ...
  Progress: "Progresso",
  private_memo:
    "Use um Memo Privado na transferência Hive (precisa da chave Memo)",
  paste_tooltip: "Colar uma fatura da Lightning em sua área de transferência",
  keepssats_error:
    "Você precisa estar logado com um saldo de KeepSats para enviar sats para um usuário Hive",
  // Login
  ...
  // Status Page
  status_page_message:
    "Página de status está em construção, por favor visite o Hive.",
  // Pricebar
  ...
  invoice_hint:
    "Cole uma fatura, escaneie um código QR ou um nome de conta Hive.",
  ...
  invoice_provider_not_working:
    "O serviço de faturas Lightning não está funcionando agora. Tente novamente ou verifique o endereço",
  ...
  please_vote:
    "Se você estiver usando o V4V.app e o achar útil, considere votar tanto em minha proposta de manutenção permanente e em minha testemunha. Isso realmente me ajuda a manter esse serviço funcionando. Obrigado!",
...
Você pode armazenar uma pequena quantia de Sats no V4V.app: seu saldo KeepSats. Este saldo é exibido no cartão de crédito quando você faz login. Sim, é o número grande!\n`,
  ...
  savings: "Poupança",
  savings_tooltip:
    "Mostrar os valores HBD e Hive armazenados nas contas de poupança da Hive blockchain",
  ...
  delete_all_pending_message:
    "Tem certeza de que deseja excluir todas as vendas pendentes?",
  delete_one_pending_message:
    "Tem certeza de que deseja excluir esta venda pendente?",
  export_to_csv: "Exportar para CSV",
  export_to_csv_tooltip:
    "Exportar todas as vendas visíveis para um arquivo CSV",
  ...
  // Loading messages
  new_content:
    "Novo conteúdo disponível; por favor, reinicie o aplicativo ou atualize.",
  // New account
  use_desktop:
    "Este processo funciona em dispositivos móveis, mas é mais fácil em um computador.",
  ...
  put_into_keychain:
    "Insira o Nome de Usuário e a Senha Mestra diretamente no Hive Keychain.",
  store_safely:
    "Armazenar a senha mestra com segurança em um Gerenciador de Senhas.",
